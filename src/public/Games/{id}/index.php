...
if (preg_match('#^/games/([0-9]+)#', $path, $matches)) {
    $id = (int)$matches[1];

    $stmt = $DBReq->prepare("
        SELECT id, name, description, ip, port, owner, ownerid, created_at, updated_at
        FROM games
        WHERE id = ?
        LIMIT 1
    ");
...
<head>
    <!-- MachineID: WEB318 -->
    <title><?php echo $gameName; ?> - ROBLOX</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,requiresActiveX=true"/>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="author" content="ROBLOX Corporation"/>
<meta name="description" content="<?php echo $gameDescription; ?>"/>
...
<meta name="google-site-verification" content="KjufnQUaDv5nXJogvDMey4G-Kb7ceUVxTdzcMaP9pCY"/>
    ...
    <meta property="og:title" content="<?php echo $gameName; ?>"/>
    <meta property="og:type" content="game"/>
    <meta property="og:url" content="/games/<?php echo $gameId; ?>/Natural-Disaster-Survival"/>
    <meta property="og:description" content="<?php echo $gameDescription; ?>"/>
    <meta property="og:image" content="/t1.rbxcdn.com/640804af4955fafb8d64c6f7a3514177"/>
    <meta property="fb:app_id" content="190191627665278">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:site" content="@ROBLOX">
    <meta name="twitter:title" content="<?php echo $gameName; ?>">
    <meta name="twitter:description" content="<?php echo $gameDescription; ?>">
    <meta name="twitter:creator">
    <meta name="twitter:image1" content="http://t1.rbxcdn.com/640804af4955fafb8d64c6f7a3514177"/>
    <meta name="twitter:app:country" content="US">
    <meta name="twitter:app:name:iphone" content="ROBLOX Mobile">
    <meta name="twitter:app:id:iphone" content="431946152">
    <meta name="twitter:app:url:iphone" content="robloxmobile://placeID=<?php echo $gameId; ?>">
    <meta name="twitter:app:name:ipad" content="ROBLOX Mobile">
    <meta name="twitter:app:id:ipad" content="431946152">
    <meta name="twitter:app:url:ipad" content="robloxmobile://placeID=<?php echo $gameId; ?>">
    <meta name="twitter:app:name:googleplay" content="ROBLOX">
    <meta name="twitter:app:id:googleplay" content="com.roblox.client">
    <meta name="twitter:app:url:googleplay" content="robloxmobile://placeID=<?php echo $gameId; ?>"/>


    <link href="/../../favicon.ico" rel="icon"/>
        <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,500,600,700" rel="stylesheet" type="text/css">

    <link rel="canonical" href="/games/<?php echo $gameId; ?>/Natural-Disaster-Survival"/>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        <meta property="al:ios:url" content="robloxmobile://placeID=<?php echo $gameId; ?>"/>
    ...
    <a class="right carousel-control" href="#carousel-game-details" role="button" data-slide="next">
        ...
        <div class="game-calls-to-action">
            ...
            <div class="game-title-container">
                <h2 class="game-name" title="<?php echo $gameName; ?>"><?php echo $gameName; ?></h2>
                <div class="game-creator"><span class="text-label">By</span> <a class="text-name" href="/users/<?php echo $gameOwnerId; ?>/profile"><?php echo $gameOwner; ?></a></div>
            </div>
...
<script type="text/javascript">
    var play_placeId = <?php echo $gameId; ?>;
    ...
    $(function () {
        ...
        $('#game-context-menu').on('click touchstart', '.VisitButtonBuild', function () {
            ...
            Roblox.Client.WaitForRoblox(function () {
                window.location =
                    '/Login/Default.aspx?ReturnUrl=http%3a%2f%2fwww.roblox.com%2fgames%2f<?php echo $gameId; ?>%2fNatural-Disaster-Survival';
            });
    ...
    $(function() {
        ...
        <li class="favorite-button-container tooltip-container" data-toggle="tooltip" title="" data-original-title="Add to Favorites">
            <a>
                ...
                <div class="icon-favorite " data-toggle-url="/favorite/toggle" data-assetid="<?php echo $gameId; ?>" data-isguest="True" data-signin-url="/newlogin?returnUrl=%2Fgames%2F<?php echo $gameId; ?>%2FNatural-Disaster-Survival">
        ...
        <li class="voting-panel body" data-asset-id="<?php echo $gameId; ?>" data-total-up-votes="269380" data-total-down-votes="21145" data-vote-modal="" data-user-authenticated="<?php echo json_encode($loggedIn); ?>">
...
<script>
    $(function () {
        ...
        Roblox.Voting.Resources = {
            ...
            guestUserMessage: "<div>You must login to vote.</div> <div>Please <a href='/newlogin?returnUrl=%2Fgames%2F<?php echo $gameId; ?>%2FNatural-Disaster-Survival'>login or register</a> to continue.</div>",
            returnUrl: '/newlogin?returnUrl=%2Fgames%2F<?php echo $gameId; ?>%2FNatural-Disaster-Survival',
    ...
    <div class="col-xs-12 rbx-tabs-horizontal" data-place-id="<?php echo $gameId; ?>">
            ...
            <div class="tab-pane active" id="about">
                <div class="section game-about-container">
                    ...
                    <div class="section-content">
                        <p class="game-description linkify"><?php echo $gameDescription; ?></p>
    ...
    <div id="rbx-vip-servers" class="container-list" data-placeid="<?php echo $gameId; ?>" data-universeid="65241" data-showshutdown data-slow-game-fps-threshold="15" data-private-server-name-max-length="50" data-private-server-name-error-text="The name of a VIP Server cannot be blank and can be no more than {0} characters." data-configure-base-url="/private-server/configure?privateServerId={0}" data-game-instances-base-url="/private-server/instance-list?universeId=65241" data-game-shutdown-url="/game-instances/shutdown" data-is-user-authenticated="<?php echo json_encode($loggedIn); ?>" data-instance-list-url="/private-server/instance-list-json" data-renew-url="/private-server/renew" data-avatar-headshot-enabled="true">
        ...
        <div class="section-content create-server-banner">
                ...
                <span class="btn-secondary-md btn-more rbx-vip-server-create" data-is-private-server="true" data-product-id="23083886" data-item-id="<?php echo $gameId; ?>" data-item-name="<?php echo $gameName; ?>" data-expected-price="300" data-expected-currency="1" data-seller-name="<?php echo $gameOwner; ?>" data-expected-seller-id="<?php echo $gameOwnerId; ?>" data-continueshopping-url="/games/<?php echo $gameId; ?>/Natural-Disaster-Survival" data-purchase-title-text="Create VIP Server" data-purchase-body-content="" data-purchase-url="/private-server/purchase" data-universe-id="65241" data-modal-field-validation-required="true" data-footer-text="Your balance after this transaction will be <span class='icon-robux-gray-16x16'></span>{0}. This is a subscription-based feature. It will auto-renew once a month until you cancel the subscription." name="CreatePrivateServer">Create VIP Server</span>
...
<script>
    ...
    + "<?php echo $gameName; ?> by <?php echo $gameOwner; ?>?<br><br>This VIP Server will start renewing every month at "
...
<li class="list-item game-card">
    ...
    <a href="/games/refer?RecommendationAlgorithm=2&amp;RecommendationSourceId=<?php echo $gameId; ?>&amp;PlaceId=180714690&amp;Position=1&amp;PageType=GameDetail" class="game-card-link">
...
<li class="list-item game-card">
    <div class="game-card-container">
    <a href="/games/refer?RecommendationAlgorithm=2&amp;RecommendationSourceId=<?php echo $gameId; ?>&amp;PlaceId=30869879&amp;Position=2&amp;PageType=GameDetail" class="game-card-link">
        <div class="game-card-thumb-container">
...
<li class="list-item game-card">
    <div class="game-card-container">
    <a href="/games/refer?RecommendationAlgorithm=2&amp;RecommendationSourceId=<?php echo $gameId; ?>&amp;PlaceId=70005410&amp;Position=3&amp;PageType=GameDetail" class="game-card-link">
        <div class="game-card-thumb-container">
...
<li class="list-item game-card">
    <div class="game-card-container">
    <a href="/games/refer?RecommendationAlgorithm=2&amp;RecommendationSourceId=<?php echo $gameId; ?>&amp;PlaceId=178704642&amp;Position=4&amp;PageType=GameDetail" class="game-card-link">
        <div class="game-card-thumb-container">
...
<li class="list-item game-card">
    <div class="game-card-container">
    <a href="/games/refer?RecommendationAlgorithm=2&amp;RecommendationSourceId=<?php echo $gameId; ?>&amp;PlaceId=230362888&amp;Position=5&amp;PageType=GameDetail" class="game-card-link">
        <div class="game-card-thumb-container">
...
<li class="list-item game-card">
    <div class="game-card-container">
    <a href="/games/refer?RecommendationAlgorithm=2&amp;RecommendationSourceId=<?php echo $gameId; ?>&amp;PlaceId=222415472&amp;Position=6&amp;PageType=GameDetail" class="game-card-link">
        <div class="game-card-thumb-container">
...
<li class="list-item game-card">
    <div class="game-card-container">
    <a href="/games/refer?RecommendationAlgorithm=2&amp;RecommendationSourceId=<?php echo $gameId; ?>&amp;PlaceId=314906000&amp;Position=7&amp;PageType=GameDetail" class="game-card-link">
        <div class="game-card-thumb-container">
...
<div>
    <div id="AjaxCommentsContainer" class="comments-container" data-asset-id="<?php echo $gameId; ?>" data-total-collection-size="" data-is-user-authenticated="<?php echo json_encode($loggedIn); ?>" data-signin-url="/newlogin?returnUrl=%2Fgames%2F<?php echo $gameId; ?>%2FNatural-Disaster-Survival">
        <div class="container-header">
            <h3>Comments</h3>
        </div>
                ...
                <div class="store-card">
                    ...
                    <div class="store-card-caption">
                        ...
                        <div class="store-card-footer">
                                <button class="PurchaseButton btn-buy-md btn-full-width rbx-gear-passes-purchase" data-item-id="118764786" data-item-name="Green Balloon" data-product-id="16523255" data-expected-price="80" data-asset-type="Game Pass" data-bc-requirement="" data-expected-seller-id="<?php echo $gameOwnerId; ?>" data-seller-name="<?php echo $gameOwner; ?>" data-expected-currency="1">
                                    <span>Buy</span>
                                </button>
                        </div>
            ...
            <li class="list-item">
                <div class="store-card">
                    ...
                    <div class="store-card-caption">
                        ...
                        <div class="store-card-footer">
                                <button class="PurchaseButton btn-buy-md btn-full-width rbx-gear-passes-purchase" data-item-id="184766955" data-item-name="Red Apple" data-product-id="21584689" data-expected-price="80" data-asset-type="Game Pass" data-bc-requirement="" data-expected-seller-id="<?php echo $gameOwnerId; ?>" data-seller-name="<?php echo $gameOwner; ?>" data-expected-currency="1">
                                    <span>Buy</span>
                                </button>
                        </div>
...
<script>
    $(function () {
        ...
        Roblox.GamePassJSData.PlaceID = <?php echo $gameId; ?>;
...
<script>
    ...
    $(function() {
        ...
        Roblox.PlaceProductPromotion.PlaceID = <?php echo $gameId; ?>;
...
<div id="rbx-leaderboard-container-clan" class="section rbx-leaderboard-container rbx-leaderboard-clan" data-associated-leaderboard-more="rbx-leaderboard-btn-clan">
    ...
    <div id="rbx-running-games" class="container-list" data-placeid="<?php echo $gameId; ?>" data-showshutdown data-avatar-headshot-enabled="true">
        <div class="container-header">
            <h3>Running Games</h3>
    ...
    <div style="min-height: 275px; background-color: white;">
        ...
        <div class="RevisedFooter">
            <div style="width:200px;margin:10px auto 0 auto;">
                <a href="/?returnUrl=https%3A%2F%2Fwww.roblox.com%2Fgames%2F<?php echo $gameId; ?>%2FNatural-Disaster-Survival"><div class="RevisedCharacterSelectSignup"></div></a>
                <a class="HaveAccount" href="/newlogin?returnUrl=https%3A%2F%2Fwww.roblox.com%2Fgames%2F<?php echo $gameId; ?>%2FNatural-Disaster-Survival">I have an account</a>
            </div>
        </div>
    </div>
</div>
