...
$bannerEnabledOnSignUp = $bannerEnabledOnSignUpPage;
?>
...
<meta name="google-site-verification" content="KjufnQUaDv5nXJogvDMey4G-Kb7ceUVxTdzcMaP9pCY"/>
    ...
    <meta property="og:image" content="/images.rbxcdn.com/fb70fd2b56107a0d43f2f98658885702.jpg"/>
    ...
    <meta name="twitter:image1" content="http://images.rbxcdn.com/fb70fd2b56107a0d43f2f98658885702.jpg"/>
...
<link rel="stylesheet" href="/static.rbxcdn.com/css/leanbase___1dcd1e0de30c586ac1ff4e343528e881_m.css/fetch"/>



<link rel="stylesheet" href="/static.rbxcdn.com/css/page___1af7e791a9430f65a2f9a2e7fec677a2_m.css/fetch"/>
...
<script type="text/javascript">window.jQuery || document.write("<script type='text/javascript' src='/js/jquery/jquery-migrate-1.2.1.js'><\/script>")</script>
    ...
    <script type="text/javascript">
        ...
        _gaq.push(['b._setCampContentKey', 'rbx_campaign']);
            ...
            _gaq.push(['b._setDomainName', 'localhost']);
    ...
    _gaq.push(['b._trackPageview']);
        ...
        _gaq.push(['c._setAccount', 'UA-26810151-2']);
            _gaq.push(['c._setDomainName', 'localhost']);
...
<style type="text/css">
    .coverSprite {
        ...
        background-image: url('/images.rbxcdn.com/20e7d1543d2c5caf201184d86530fc35.png');
    }

    #RollerContainer {
        background-image: url('/images.rbxcdn.com/dcbdfaf1c08058e71f65c09f7b98ff04.jpg');
        background-repeat: no-repeat;
    ...
    .special-dropdown select {
        ...
        -moz-appearance: none;
        background: url('/images.rbxcdn.com/379f4f1018f31cbb62ef52a22d9f2118.png') no-repeat;
    ...
    #InnerWhatsRobloxContainer1 {
        height: 70%;
        background-image: url('/images.rbxcdn.com/cca69eca62f23ca413fc920549e936ea.jpg');
        background-repeat: no-repeat;
        background-size: cover;
    ...
    #GameImage1 {
        background-image: url('/images.rbxcdn.com/42268b6264d89827401ef912f174f288.jpg');
        margin-right: 5px;
    }

    #GameImage2 {
        background-image: url('/images.rbxcdn.com/04baeb33ef66ef1395cd5464309fece6.jpg');
        margin-right: 5px;
    }

    #GameImage3 {
        background-image: url('/images.rbxcdn.com/e8b89d14690203420d64b5b2fda0b461.jpg');
        margin-right: -10px;
    ...
    <div class="container">
        <div class="row">
            <div class="navbar-header col-md-6">
                ...
                <div class="navbar-brand hidden-xs"><img alt="Roblox Logo" class="robloxLogo" src="/images.rbxcdn.com/e870a0b9bcd987fbe7f730c8002f8faa.png"/></div>
...
<?php if (!empty($banner) && $bannerEnabledOnSignUp == true): ?>
                ...
                <div class="col-xs-12 col-md-6">
                    <div id="MainLogo" class="text-right">
                        <div id="LogoAndSlogan" class="text-center">
                            <img id="MainLogoImage" title="ROBLOX" class="center-block img-responsive" src="/images.rbxcdn.com/39ae3ca577c8488487ef492031b8e264.png"/>
                            <div class="clearfix"></div>
                            <h1>Powering Nostalgia<span> &#8482; </span></h1>
...
<style type="text/css">
    .male {
        background-image: url('/images.rbxcdn.com/856241927a2ac609e3033feada3ef9f9.png');
        background-repeat: no-repeat;
    }
    .female {
        background-image: url('/images.rbxcdn.com/a0afd0556163477e1023c5aa55d1b9f6.png');
        background-repeat: no-repeat;
    }
</style>
...
<img src="/timg/rbx" style="position: absolute"/>
            <div class="form-group" ng-class="{'has-error' : (badSubmit || signupForm.username.$dirty) &amp;&amp; signupForm.username.$invalid, 'has-success': (signupForm.username.$dirty &amp;&amp; signupForm.username.$valid) }">
                <input id="signup-username" ng-trim="false" ng-change="onChange()" name="username" class="form-control input-field" type="text" tabindex="1" rbx-valid-username rbx-form-interaction rbx-form-validation placeholder="Username (don't use your real name)" ng-model="signup.username"/>
            ...
            <div class="legal-text-container">
                By signing up you agree to our <a href="/info/terms-of-service" target="_blank">Terms</a> and <a href="/Info/Privacy.aspx" target="_blank">Privacy Policy</a>
            </div>
            <button id="signup-button" type="button" tabindex="9" class="btn-primary-md signup-submit-button" rbx-form-interaction name="signupSubmit" ng-disabled="isSubmitting" data-signup-api-url="/signup/v1" ng-click="submitSignup($event)" ng-keypress="submitSignup($event)">Sign Up</button>
            <noscript>
    ...
    <div class="captcha-container" ng-controller="CaptchaController" ng-form name="captchaForm" rbx-form-context context="RollerCoaster" ng-cloak ng-show="isSectionShown">
...
</script><script type="text/javascript" src="/www.google.com/recaptcha/api/challenge?k=6Le88gcTAAAAALG04IFgQDENWlQmc_hy_3tdF1yY">
        ...
        <button id="CaptchaSubmitButton" class="btn-primary-md captcha-submit-button" data-signup-captcha-api-url="/captcha/validate/signup" data-log-in-captcha-api-url="/captcha/validate/login" ng-click="submitCaptcha($event)" ng-disabled="isSubmitting" rbx-form-interaction name="captchaSubmit">
            Submit
        </button>
        ...
        <div class="row" id="DeviceImageContainer">
            <div class="col-md-12">
                <div class="row text-center">
                    <img id="ComputerImgSmall" class="center-block img-responsive hidden-lg ComputerImg" src="/images.rbxcdn.com/0ad1ae4bf929fb82cad6f30fdf03b6db.png"/>
                    <img class="center-block img-responsive visible-lg-block ComputerImg" src="/images.rbxcdn.com/9edeef823842e76479587a57c05cb5bc.png"/>
        ...
        <ul id="AppStoreContainer" class="row text-center app-store-container row-five">
            <li>
                <a href="https://itunes.apple.com/us/app/roblox-mobile/id431946152" target="_blank" class="app-store-link-apple">
                    <img class="app-store-logo" src="/images.rbxcdn.com/9819a104fc46fb90d183387ba81065a0.png" title="ROBLOX on App Store"/>
                </a>
            </li>
            <li>
                <a href="https://play.google.com/store/apps/details?id=com.roblox.client&amp;hl=en" target="_blank" class="app-store-link-android">
                    <img class="app-store-logo" src="/images.rbxcdn.com/75ba3866ee59c113220b369c2432c7f9.png" title="ROBLOX on Google Play"/>
                </a>
            </li>
            <li>
                <a href="http://amzn.com/B00NUF4YOA" target="_blank" class="app-store-link-amazon">
                    <img class="app-store-logo" src="/images.rbxcdn.com/29d56f5d7a8c1d6d4a267b28134e221d.png" title="ROBLOX on Amazon Store"/>
                </a>
            </li>
            <li>
                <a href="http://store.xbox.com/en-US/Xbox-One/Games/ROBLOX/c79323fd-00f8-462a-a97a-39a0eb61791e" target="_blank" class="app-store-link-xbox">
                    <img class="app-store-logo" src="/images.rbxcdn.com/cfbff08ccdfe3e51898dfecf5635dc2a.png" title="ROBLOX on Xbox Store"/>
                </a>
            </li>
                <li>
                    <a href="https://www.microsoft.com/en-us/store/games/roblox/9nblgggzm6wm" target="_blank" class="app-store-link-windows10">
                        <img class="app-store-logo" src="/images.rbxcdn.com/6e6e44a25ac2fc28a678880c2fec24a9.png" title="ROBLOX on Windows Store"/>
                    </a>
...
<script type="application/ld+json">
    ...
    "name" : "Roblox",
    "url" : "http://localhost/",
    "logo": "http://images.rbxcdn.com/e870a0b9bcd987fbe7f730c8002f8faa.png",
    "sameAs" : [
    ...
    <script type="text/javascript" src="/js.rbxcdn.com/45b2fa0efc7a63d10d3455d19d77646e.js"></script>
...
<script type="text/javascript" src="/js.rbxcdn.com/55204f6c51a6c3a803c608bf7bbd3285.js"></script>
    ...
    <script>
        Roblox.XsrfToken.setToken('9tpMuw05bhd+');
    </script>
...
<script type="text/javascript">
    ...
    <script type="text/javascript" src="/js.rbxcdn.com/21cb8556d2bc535297c9769314eb7920.js"></script>
