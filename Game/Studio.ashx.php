...
?>
%pmXCbfOK1AlHTjBsAPDZ8kiEicYdQzpY7ZhgTe6TSVAu8n2x7PD/D/18P3/PVZgcgeav6TCbUYt+VeASLHu/40vGLsr7kNl9m3OFaTImAmUpBFtSpmVcu1mOFRZLgjCmVmwH04FqdcHaM8CJWb77QIiNRF7eWURfV/nX8D6zfQ4=%
...
pcall(function() game:GetService("MarketplaceService"):SetProductInfoUrl("https://web.archive.org/web/20220220165752/https://api.idk16.xyz/marketplace/productinfo?assetId=%d") end)
pcall(function() game:GetService("MarketplaceService"):SetDevProductInfoUrl("https://web.archive.org/web/20220220165752/https://api.idk16.xyz/marketplace/productDetails?productId=%d") end)
pcall(function() game:GetService("MarketplaceService"):SetPlayerOwnsAssetUrl("https://web.archive.org/web/20220220165752/https://api.idk16.xyz/ownership/hasasset?userId=%d&assetId=%d") end)
