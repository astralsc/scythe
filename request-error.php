...
/*if (!$code == 404) {
    header('Location: request-error?id=&mode=&code=404');
}*/
?>
...
<div class="request-error-page-content">
    <div class="default-error-page">
        ...
        <img src="/images.rbxcdn.com/4bd2ab534d227b98097ab7730f61f49a.png" class="error-image" alt="Error Image"/>
    ...
    <div style="min-height: 275px; background-color: white;">
        ...
        <div class="RevisedFooter">
            <div style="width:200px;margin:10px auto 0 auto;">
                <a href="/?returnUrl=https%3A%2F%2Fwww.roblox.com%2Frequest-error%3Fid%3D%26mode%3D%26code%3D404"><div class="RevisedCharacterSelectSignup"></div></a>
                <a class="HaveAccount" href="/newlogin?returnUrl=https%3A%2F%2Fwww.roblox.com%2Frequest-error%3Fid%3D%26mode%3D%26code%3D404">I have an account</a>
            </div>
        </div>
    </div>
</div>
